  ...
  return (
    <footer className="footer p-10 bg-neutral text-neutral-content" style={{background: "black"}}>
        <div style={{position: 'relative', paddingTop: " "}}>
            <p>El código de esta aplicación está disponible, lo que significa que puedes copiar y manipular el código libremente. <br/> Agradecería  una mención si utilizas este código</p>
        </div> 
        <div>
